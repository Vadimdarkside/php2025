...
Route::get('/trainers', [TrainerController::class, "read"])->name('/trainers');
...
Route::get('/programs', [WorkoutController::class, "read"])->name('/programs');
...
Route::get('/enrolls', [EnrollmentController::class, "read"])->name(name: '/enrolls');
...
Route::get('/payments', [PaymentController::class, "read"])->name('/payments');
